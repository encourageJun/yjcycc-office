package org.yjcycc.office.common.tools.config;
 ...
 *
 */
public class OfficeRmiConfig {

	private static Logger logger = Logger.getLogger(OfficeRmiConfig.class);

	private static final OfficeRmiConfig instance = new OfficeRmiConfig();

	private static final String CONFIG_FILE = "office.rmi.properties";
	...
	public static final OfficeRmiConfig getInstance() {
		return instance;
	}
